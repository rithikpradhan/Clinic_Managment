          ...
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
            ...
            <div className="flex flex-wrap items-center gap-2 sm:gap-3 w-full lg:w-auto">
              ...
              <div className="flex items-center gap-1.5 p-1 bg-gray-50 rounded-xl border border-gray-100">
                <Button onClick={() => exportToCSV(paginated)} variant="ghost" size="icon" className="h-8 w-8 text-gray-400 hover:text-blue-600 hover:bg-white rounded-lg transition-all">
                  <Download size={16} />
                </Button>
                            ...
                            {(() => {
                              ...
                              return (
                                <>
                                  ...
                                  <DropdownMenuSub>
                                    <DropdownMenuSubTrigger className="rounded-xl px-3 py-2 font-bold text-sm text-blue-600">
                                      All Treatments
                                    </DropdownMenuSubTrigger>
                                    <DropdownMenuSubContent className="rounded-xl p-1.5 shadow-lg border-gray-100 ml-1 min-w-[160px]">
                                      {availableDoctors.map((doc) => (
      ...
      <Dialog open={!!completeAppt} onOpenChange={o => !o && setCompleteAppt(null)}>
        <DialogContent className="sm:max-w-md rounded-3xl border-none shadow-2xl p-0 overflow-hidden">
          <div className="bg-emerald-500 p-8 text-white text-center space-y-2">
             ...
             <h3 className="text-xl font-bold tracking-tight">Visit Completed!</h3>
          ...
          <div className="p-8 space-y-6">
             <div className="flex items-center justify-between p-4 bg-slate-50 rounded-2xl border border-slate-100">
                <div className="flex items-center gap-3">
                   ...
                   <div>
                      <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Est. Amount</p>
                ...
                <Badge className="bg-blue-100 text-blue-600 border-none font-bold text-[10px]">INVOICE READY</Badge>
             </div>
             
             <div className="flex gap-3">
                <Button variant="ghost" onClick={() => setCompleteAppt(null)} className="flex-1 rounded-xl font-bold text-slate-400">Later</Button>
                <Button 
                  className="flex-[2] bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-bold gap-2 shadow-lg shadow-blue-100"
                  onClick={() => {
        ...
        <DialogContent className="sm:max-w-md rounded-3xl border-none shadow-2xl p-0 overflow-hidden">
              ...
              allTreatments.map(t => {
                ...
                return (
                  ...
                  >
                    ...
                    {t.price && (
                      <span className="text-sm font-bold text-blue-600 shrink-0">₹{t.price.toLocaleString()}</span>
                    )}
                  </button>
                );
              })
          ...
          <div className="p-6 pt-0 flex gap-3">
            ...
            <Button
              ...
              className="flex-[2] bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-bold gap-2"
            >
